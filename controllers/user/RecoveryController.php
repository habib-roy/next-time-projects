...
class RecoveryController extends Controller
{
    ...
    public function actionRequest()
    {
        ...
        if ($model->load(\Yii::$app->request->post()) && $model->sendRecoveryMessage()) {
            ...
            return $this->render('@app/views/user/message', [
                'title'  => \Yii::t('user', 'Recovery message sent'),
                'module' => $this->module,
            ]);
        }

        return $this->render('@app/views/user/recovery/request', [
            'model' => $model,
            'module' => $this->module,
        ]);
    }
    ...
    public function actionReset($id, $code)
    {
        ...
        if ($token === null || $token->isExpired || $token->user === null) {
            ...
            \Yii::$app->session->setFlash('danger', 'Tautan tidak valid atau telah kadaluarsa. Silakan coba meminta tautan yang baru.');
            return $this->render('@app/views/user/message', [
                'title'  => 'Tautan tidak valid atau telah kadaluarsa',
                'module' => $this->module,
            ]);
        }
        ...
        return $this->render('@app/views/user/recovery/reset', [
            'model' => $model,
        ]);
    }
}
