                ...
                <div class="text-inner">
                    <div class="row">
                        ...
                        <div class="col-md-12 section-heading text-center" style="margin-bottom:0px;padding-bottom:0px;">
                            <h2 class="fade to-animate">Pemulihan Password</h2>
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2 subtext fade to-animate">
                                    <p style="color:rgba(255,255,255,0.8)">Masukkan password baru Anda.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 fade to-animate">
                            ...
                            <?= $form->field($model, 'password')->passwordInput(['placeholder' => 'MASUKKAN PASSWORD BARU ANDA', 'style' => 'text-align:center']) ?>

                            <?= Html::submitButton('Selesai', ['class' => 'btn btn-primary btn-block']) ?><br>
